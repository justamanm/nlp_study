...
<img src="../../../python%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0/my/%E7%AC%94%E8%AE%B0/pic/attention%20encoder.jpg" width="50%">
...
- mask的原因：是因为每次输入都只是预测获得的部分语句，所以要把后面的次置为0（使得$e^x$为0）
...
- 根据句子动态的产生词向量，解决word2vec唯一词向量无法应对一词多义的情况

  <img src="pic/model/elmo 结构.jpg" width="60%">
...
- 随机将15%的输入mask，即可实现双向语言模型，即实现类似cbow的效果
- 与cbow对比
  - [BERT 的 Masked Language Model（MLM）任务和 CBOW 的任务有什么区别？ - 如火而飞的回答 - 知乎](https://www.zhihu.com/question/323267834/answer/675454605)
